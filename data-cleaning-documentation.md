...
|:---------------|:--------------|:---------------|:----------------|:---------------|:----------------|
|HCUP_2004-2021_CommonOperations| **Patient:** Maternal/Neonatal Stays, Age <br><br> **Hospital Encounters:** Number of Stays <br><br>**Conditions/Diagnoses:** Procedure, Rank | **High Relevance**  _Patient demographic_ details will differentiate between maternal and neonatal stays, while _hospital encounter_ details and _conditions/diagnoses_ fields will reveal the volume of encounters that are associated with specific conditions. |1440 records blank in field "Rate of Stays/100,000." 2881 records blank in field "Total Number of Stays, Weighted".|Decision|Reason for Inclusion/Exclusion|
